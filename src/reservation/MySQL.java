...
public class MySQL {
	...
	public MySQL() {
		...
		this.dbname  = "50416025";         // データベース名;
		this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
		this.user = "50416025";         // データベース作成ユーザ名;
		this.password  = "50416025";     // データベース作成ユーザパスワード;
...
public ResultSet getInformation(String facility){
...
public ResultSet getReservationAll(String facility){
...
public ResultSet deleteReservation2(String rdate, String st, String et, String reservation_userid, String facility){
...
public int deleteReservation(String rdate, String st, String et, String reservation_userid, String facility){
	int rs_int = 0;
	String sql = "DELETE FROM reservation WHERE date ='" + rdate + "' AND facility_name = '"+ facility +"' AND start_time = '"+ st + "' AND end_time = '"+ et + "'ORDER BY start_time;"; 
	    	  try {
				rs_int = stmt.executeUpdate(sql);
			} catch (SQLException e) {
				// TODO Auto-generated catch block
