...
public class MainFrame extends Frame implements ActionListener,WindowListener,KeyListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if (e.getSource() == buttonReservation){//予約するときボタン
			result = reservationControl.makeReservation(this);
		}else if (e.getSource() == buttonExplanation){//施設概要ボタン
			result = reservationControl.facilityInfomation(choiceFacility.getSelectedItem());
		}else if (e.getSource() == buttonConfirm){//予約確認ボタン
			result = reservationControl.getReservationAll(choiceFacility.getSelectedItem());
		}else if (e.getSource() == buttonCancel){//予約消すときボタン
